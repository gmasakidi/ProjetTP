        ...
        <div class="col-12 mt-4 d-flex justify-content-center">
            <form action="addArticle.php" method="post" enctype="multipart/form-data" class="w-50 mb-5">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="articleContent" class="form-control <?= !empty($formErrors['articleContent']) ? 'is-invalid' : ''; ?>" id="articleContent" rows="5" cols="33"><?= @$_POST['articleContent']; ?></textarea>
